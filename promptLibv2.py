...
""",
f"""Summarize in two sentences the following text
...
""",
f"""A "table of content" is an ordered list of the topic contained in the text: write the "Table of Contents" of the following text. 
...
""",
f"""write the five most important topics from the following text:
